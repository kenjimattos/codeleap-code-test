// Mock data - 35 posts for testing pagination
// This file is only imported in test and development (with REACT_APP_USE_MOCK=true)
...
export function getMockPaginatedPosts(offset = 0) {
